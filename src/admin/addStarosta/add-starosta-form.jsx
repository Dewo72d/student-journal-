    ...
    return (
        <div>
            <form onSubmit={handleSubmit(onSubmit, onErr)} id="insert_starosta" className={classes.card}>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button variant="contained" color="primary" type="submit" form="insert_starosta" onClick={handleClose}>
                            Добавити
        </Button>
                    </DialogActions>
                </Dialog>
            ...
            <div className={classes.alert}>
                ...
                </Alert>) : result.message == 'Помилка' || result.message == 'Такої групи або студента не існує' ? (<div>
